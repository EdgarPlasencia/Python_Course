#Author: Edgar Plasencia

#Data type/Tipos de datos
...
#Using a python function to determine data type
#Usando una funcion de python para determinar el tipo de dato
print(type(num01))
print(type(num02))
print(type(num03))
print(type(num04))
